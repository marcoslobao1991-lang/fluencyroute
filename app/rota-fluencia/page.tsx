...
import '../vsl/vsl.css'
import { C, FONT } from '../vsl/design'
import { Fade, Glass, Label, S, Grad, useInView } from '../vsl/primitives'

// Lazy load heavy graph components — only downloaded after reveal
const VocabCoverage = lazy(() => import('../vsl/graphs/VocabCoverage').then(m => ({ default: m.VocabCoverage })))
...
// ═══════════════════════════════════════════════════════════════
// CTA BUTTON — points to /rota-fluencia/checkout
// ═══════════════════════════════════════════════════════════════
function Btn({ text = 'QUERO FAZER PARTE', compact }: { text?: string; compact?: boolean }) {
  return (
    <Link href="/rota-fluencia/checkout" prefetch={true} className="cta-btn"
