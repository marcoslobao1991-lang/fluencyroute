...
export default function RotaFluenciaPage({ alwaysOpen = false, vsl2 = false }: { alwaysOpen?: boolean; vsl2?: boolean }) {
  ...
  useEffect(() => {
    ...
    // /aberta passa alwaysOpen; ?reveal=1 faz o mesmo em preview/dev — abre tudo
    // de cara, sem timer e sem persistir em localStorage
    const previewReveal = alwaysOpen || new URLSearchParams(location.search).get('reveal') === '1'
