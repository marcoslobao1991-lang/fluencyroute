...
import ManuOrb, { type ManuMood } from '../bridge/ManuOrb'
import { usePronunciation, type PronResult } from '../bridge/usePronunciation'
import LINES from '../bridge/manu-lines.json'
import CAPTIONS from '../bridge/manu-captions.json'

const frTrack = createTracker({ funnel: 'ingles', page: 'bridge-demo', variant: 'B' })
