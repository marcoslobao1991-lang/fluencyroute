// ═══════════════════════════════════════════════════════════════
// Meta Conversions API (Server-Side) — Fluency Route LATAM ES (mercado USD)
//
// Clone isolado de meta-capi.js pro pixel do LATAM (es. neutro, curso de inglês). Pixel + token PRÓPRIOS
// (não toca o inglês). event_id DEVE casar com o browser pixel, senão o
// Facebook conta DOBRADO.
// ═══════════════════════════════════════════════════════════════

const PIXEL_ID = '604755389004843'
const ACCESS_TOKEN = process.env.META_CAPI_TOKEN_LATAM
...
/**
 * Send server-side event to Meta Conversions API (LATAM pixel)
