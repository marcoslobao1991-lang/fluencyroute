...
export async function POST(request: Request) {
  ...
  <div style="max-width:480px;margin:0 auto;padding:32px 24px">
    ...
    <p style="font-size:16px;color:#3D4A49;line-height:1.65">Você acabou de entrar na plataforma pelo site. Se precisar entrar de novo, use o botão abaixo: ele te leva pra entrada sem senha, sempre que precisar.</p>
    <a href="${emailLink}" style="display:inline-block;margin:16px 0 8px;background:#0B6E68;color:#fff;font-weight:900;font-size:16px;padding:16px 28px;border-radius:12px;text-decoration:none">ENTRAR NA PLATAFORMA ▶</a>
  </div></body></html>`;
