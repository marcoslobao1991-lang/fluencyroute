// ═══════════════════════════════════════════════════════════════
// app/api/track-latam/route.js — Server-side Meta CAPI relay (LATAM pixel)
// Clone isolado de /api/track pro pixel do LATAM (604755389004843).
// Hasheia PII em SHA256 antes de enviar ao Meta.
// ═══════════════════════════════════════════════════════════════

import { sendServerEvent } from '../../lib/meta-capi-latam.js'
