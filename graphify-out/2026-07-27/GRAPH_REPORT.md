# Graph Report - fluencyroute  (2026-07-27)

## Corpus Check
- 144 files · ~329,246 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 195 nodes · 219 edges · 20 communities (16 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f491d8b9`
...
## Knowledge Gaps
- **81 isolated node(s):** `VocabCoverage`, `PHASES`, `SERIES`, `SERIES_LOOP`, `FAQ` (+76 more)
